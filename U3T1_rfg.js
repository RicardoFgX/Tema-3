...
let num1;
let num2;
let solucion = No se ha introducido un valor de operación válido;
...
// Función para realizar la división
function division(num1, num2) {
    console.log(num2 === 0); // <-Si num2 se ha introducido como un "0" establece falsa esta condición lo que no tiene sentido
    if (num2 === 0) { // <-Esta condición no funciona bien
        return "No se puede dividir por cero.";
    } else {
        return num1 / num2;
    }
...
while (true) {
    ...
    if (respuesta1 === null || respuesta1.includes(" ") || respuesta1 === "") {
        ...
        num1 = new Number(respuesta1); //A diferencia de la otra solución aqui se convierte el num en un Number en vez de parseInt
        if (isNaN(num1)) {
            alert("El valor introducido no es un número");
            break;
        } else {
    ...
    if (respuesta2 === null || respuesta2.includes(" ") || respuesta2 === "") {
        ...
        num2 = new Number(respuesta2); //A diferencia de la otra solución aqui se convierte el num en un Number en vez de parseInt
        if (isNaN(num2)) {
            alert("El valor introducido no es un número");
            break;
        } else {
